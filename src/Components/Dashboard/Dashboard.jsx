                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                <label className="flex items-center">
                                                    <input type="checkbox" name="permissions" value="manage_users" className="rounded text-indigo-600" />
                                                    <span className="ml-2 text-sm text-gray-700">Manage Users</span>
                                                </label>
                                                <label className="flex items-center">
                                                    <input type="checkbox" name="permissions" value="manage_inventory" className="rounded text-indigo-600" />
                                                    <span className="ml-2 text-sm text-gray-700">Manage Inventory</span>
                                                </label>
                                                <label className="flex items-center">
                                                    <input type="checkbox" name="permissions" value="view_reports" className="rounded text-indigo-600" />
                                                    <span className="ml-2 text-sm text-gray-700">View Reports</span>
                                                </label>
                                                <label className="flex items-center">
                                                    <input type="checkbox" name="permissions" value="manage_orders" className="rounded text-indigo-600" />
                                                    <span className="ml-2 text-sm text-gray-700">Manage Orders</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div className="flex justify-end space-x-3 mt-6">
