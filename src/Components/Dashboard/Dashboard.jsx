        ...
        <div className="p-4">
            ...
            <div className="row mb-4">
                    ...
                    <div className="dashboard-card">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div className="d-flex">
                                ...
                                <button className="btn btn-sm btn-primary rounded-pill me-2">
                                    Monthly
                                </button>
                        ...
                        <div id="salesChart" className="chart-container"></div>
                    </div>
                </div>
                ...
                <div className="col-lg-6">
                    <div className="dashboard-card">
                        ...
                        <div id="categoryChart" className="chart-container"></div>
                    </div>
                </div>
            </div>
                            ...
                            <table className="table table-hover mb-0">
                                <thead className="table-light">
                                    <tr>
                                        ...
                                        <th className="text-muted small text-uppercase">Customer</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Tesla Model Y</td>
                                        <td className="fw-medium">$58,990</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="fw-medium">$62,500</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rivian R1S</td>
                                        <td className="fw-medium">$78,000</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Lucid Air</td>
                                        <td className="fw-medium">$87,400</td>
                                        <td>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="progress progress-thin mb-3">
                                <div 
                                    ...
                                    role="progressbar" 
                                    style={{width: "68%", backgroundColor: "rgba(87, 181, 231, 1)"}}
                                ></div>
                            </div>
            ...
            <div className="row mb-4">
                <div className="col-12">
                    <div className="dashboard-card">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            <h3 className="h5 mb-0">Production Timeline</h3>
                            <div className="d-flex">
            ...
            <div className="row">
                <div className="col-12">
                    <div className="dashboard-card">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            <h3 className="h5 mb-0">Google Sheets Sync Status</h3>
                            <button className="btn btn-primary rounded-pill">
