                    ...
                    <div className="flex flex-wrap gap-4">
                        <Link to="/dealershipmanagement">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition cursor-pointer whitespace-nowrap"
                            >
                                <i className="fas fa-store"></i> Dealership
                            </button>
                        </Link>
                        <Link to="/usermanagement">
                            <button
                                id="add-user-btn"
                                className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition cursor-pointer whitespace-nowrap"
                            >
                                <i className="fas fa-user mr-2"></i> User
                            </button>
                        </Link>
