          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h2 className="text-sm font-medium text-gray-600">Processing</h2>
                  <p className="text-2xl font-bold text-gray-800">{processingOrders}</p>
                </div>
              </div>
              <div className="mt-4 flex items-center text-sm">
                <span className="text-green-500 flex items-center">
              ...
              <div className="lg:col-span-1 bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="mt-6 pt-6 border-t">
                  <button className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 cursor-pointer !rounded-button whitespace-nowrap">
                    <i className="fas fa-file-export mr-2"></i> Export Orders
                  </button>
                </div>
              </div>
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  <div id="order-stats-chart" style={{ height: '250px' }}></div>
                </div>
                <div className="bg-white rounded-lg border border-gray-200 p-6">
