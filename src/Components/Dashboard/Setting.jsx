...
const Setting = () => {
    ...
    return (
        <div className="d-flex vh-100 bg-light p-4">

            <main className="p-6 min-vh-100">
                    ...
                    <div className="bg-white rounded shadow overflow-hidden mb-8">
                        <div className="border-bottom">
                            <nav className="nav nav-tabs d-flex overflow-auto">
                                <button
                            ...
                            {activeTab === 'inventory' && (
                                <div>
                                    ...
                                    <div className="bg-white border rounded p-4 mb-4">
                                        ...
                                        <div className="row gap-4">
                                            <div className="col-md-5">
                                                <label className="form-label text-muted mb-1">Low Stock Threshold</label>
                                                <div className="input-group">
                                                    <button
                                                        type="button"
