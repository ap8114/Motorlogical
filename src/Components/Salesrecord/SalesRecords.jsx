...
const SalesRecords = () => {
  // Sample data - only including delivered items
  const salesData = [
    {
      id: 'SL-2025-8740',
      product: 'Tesla Model S Plaid',
    ...
    {
      id: 'SL-2025-8730',
      product: 'Ferrari 488 GTB',
      price: 275000.00,
      date: '06/01/2025',
      customer: 'James Wilson',
      note: 'VIP customer with previous purchases. Custom color scheme requested. Full payment upfront.',
      color: 'red',
      status: 'Delivered'
    },
    {
      ...
      note: 'First-time Audi buyer. Included performance package and ceramic brakes.',
      color: 'blue',
      status: 'Delivered'
    },
    {
      id: 'SL-2025-8725',
      product: 'BMW M8 Competition',
      price: 135000.00,
      date: '05/28/2025',
      customer: 'Robert Johnson',
      note: 'Corporate lease. Included executive package and Bowers & Wilkins sound system.',
      color: 'blue',
      status: 'Delivered'
    },
    {
      ...
      note: 'Upgrade from E-Class. Selected AMG line with night package.',
      color: 'black',
      status: 'Delivered'
    }
  ];
  ...
  const averageSale = totalUnits > 0 ? totalSales / totalUnits : 0;

  // Get model distribution
  const modelDistribution = filteredData.reduce((acc, sale) => {
  ...
  useEffect(() => {
    ...
    setFilteredData(result);
    setCurrentPage(1); // Reset to first page when filters change
  }, [searchTerm, dateFrom, dateTo, sortField, sortDirection]);
  ...
  // Get badge color based on status
  const getStatusBadge = (status) => {
    return 'success'; // All items are delivered, so always return success
  };
  ...
  const getIconColor = (color) => {
    return {
      ...
      orange: { bg: 'bg-danger', text: 'text-white' },
      teal: { bg: 'bg-warning', text: 'text-white' },
      black: { bg: 'bg-dark', text: 'text-white' }
    }[color] || { bg: 'bg-secondary', text: 'text-white' };
  };

  // Export to Excel
  const handleExport = () => {
    alert('Exporting delivered sales data to Excel...');
  };
  ...
  return (
    <div className="min-vh-100 bg-light">
      ...
      <header className="bg-white mt-3 shadow-sm">
        <div className="p-3">
          <div className="d-flex justify-content-between align-items-center">
            <h1 className="h3 mb-0 text-dark">Delivered Sales Records</h1>
            <div className="d-flex align-items-center gap-3">
              <span className="text-muted">
                Dealership: <span className="fw-semibold">Luxury Motors Beverly Hills</span>
              </span>
      ...
      <main className="py-4">
        <div className="">
          ...
          <div className="card mb-4">
            <div className="card-body">
              <div className="row g-3">
                ...
                <div className="col-md-4">
                  <label className="form-label small fw-semibold">Delivery Date From</label>
                  <div className="input-group">
                    <span className="input-group-text bg-light border-end-0">
                      <FiCalendar className="text-muted" />
                    </span>
                ...
                <div className="col-md-4">
                  <label className="form-label small fw-semibold">Delivery Date To</label>
                  <div className="input-group">
                    <span className="input-group-text bg-light border-end-0">
                      <FiCalendar className="text-muted" />
                    </span>
          ...
          <div className="card mb-4">
            <div className="card-header bg-white d-flex justify-content-between align-items-center border-bottom">
              <h2 className="h5 mb-0">Completed Deliveries</h2>
              <div className="text-muted small">
                Showing only delivered units - Last updated: June 13, 2025 at 10:45 AM
              </div>
            </div>
            <div className="table-responsive">
              <Table hover className="mb-0">
                ...
                <tbody>
                  {currentItems.map((sale, index) => (
                    <tr key={index}>
                      ...
                      <td className="fw-semibold text-end">${sale.price.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                      <td>{sale.date}</td>
                      <td>{sale.customer}</td>
                      <td>
                        <div 
                      ...
                      <td>
                        <Button variant="link" size="sm" onClick={() => handleShowDetail(sale)}>
          ...
          <div className="card">
            <div className="card-body">
              <h2 className="h5 mb-4">Delivered Sales Summary</h2>
              <Row>
                  ...
                  <Card>
                    <Card.Body>
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="text-muted small mb-1">Total Sales (This Month)</p>
                          <h3 className="mb-0">${totalSales.toLocaleString('en-US', { minimumFractionDigits: 2 })}</h3>
                        </div>
                        <div className="rounded-circle bg-success bg-opacity-10 d-flex align-items-center justify-content-center" style={{ width: '48px', height: '48px' }}>
                          <FaMoneyBillWave className="text-success" size={20} />
                        </div>
                ...
                <Col md={3} className="mb-3 mb-md-0">
                  <Card>
                    <Card.Body>
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="text-muted small mb-1">Total Units Delivered</p>
                ...
                <Col md={3} className="mb-3 mb-md-0">
                  <Card>
                    <Card.Body>
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="text-muted small mb-1">Average Delivery Value</p>
                          <h3 className="mb-0">${averageSale.toLocaleString('en-US', { minimumFractionDigits: 2 })}</h3>
                        </div>
                        <div className="rounded-circle bg-purple bg-opacity-10 d-flex align-items-center justify-content-center" style={{ width: '48px', height: '48px' }}>
                          <FaChartLine className="text-purple" size={20} />
                        </div>
                ...
                <Col md={3}>
                  <Card>
                    <Card.Body>
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="text-muted small mb-1">Model Distribution</p>
                          <div className="small">
                        ...
                        <div className="rounded-circle bg-info bg-opacity-10 d-flex align-items-center justify-content-center" style={{ width: '48px', height: '48px' }}>
        ...
        <Modal.Body className="overflow-auto" style={{ maxHeight: '60vh' }}>
          {currentSale && (
            <Row>
              ...
              <Col md={6}>
                <h5 className="text-muted small mb-2">Delivery Information</h5>
                <Card className="mb-4">
                  <Card.Body>
                    <div className="row small">
                      <div className="col-6 mb-2">
                ...
                <Card className="mb-4">
                  <Card.Body>
                    ...
                    <div className="small">
                      <span className="text-muted">Delivery Confirmed:</span>
                      <span className="ms-1">
                        {new Date(currentSale.date).toLocaleDateString('en-US', {
                          month: 'long',
                          day: 'numeric',
                          year: 'numeric'
                        })}
          ...
          <h5 className="text-muted small mb-2">Delivery Notes</h5>
          <Card>
            <Card.Body>
              <p className="small mb-0">{currentSale?.note}</p>
            </Card.Body>
